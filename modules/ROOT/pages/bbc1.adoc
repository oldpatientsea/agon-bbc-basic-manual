...
Note, this is an incomplete first draft so please hold off with flagging issues until the documentation is in a more finished state. Once a stable release is complete, please then feel free to raise issues on github pages with questions, requests for clarification, errors spotted and suggestions for enhancements. 
