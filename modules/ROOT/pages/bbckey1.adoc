...
Instead of implenting an EDIT keywords, BBC BASIC for Z80 (Agon) delegates this functionality to the MOS command of the same name.

Remember therefore to use the `*` key when calling it.
